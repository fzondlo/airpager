...
class HospitableWebhooksIntegrationTest < ActionDispatch::IntegrationTest
  def test_creates_incident_when_message_from_guest
    assert_difference -> { Incident.count }, 1 do
      post_hospitable_message_webhook(conversation_id: "test-convo-123", sender_role: "")
    end
  ...
  def post_hospitable_message_webhook(conversation_id: "becd1474-ccd1-40bf-9ce8-04456bfa338d", sender_role: "")
